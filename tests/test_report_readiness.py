...
def test_readiness_accepts_boolean_check_and_explicit_governing_declaration():
    graph = {
        "graph_id": "ready",
        ...
        "nodes": [
            ...
            _node(
                ...
                "result",
                ["eta"],
                report_spec={"governing_quantity_id": "eta"},
            ),
        ],
    }
    ...
    graph = {
        ...
        "nodes": [
            _node(
                ...
                "result",
                ["eta"],
                report_spec={"governing_quantity_id": "other"},
            )
        ],
    }
    report = build_report_readiness(DummyModel(graph))
...
def test_active_v0370_dag_has_stable_static_readiness_census_without_execution():
    ...
    assert report["check_verdict_readiness"]["check_node_count"] > 0
